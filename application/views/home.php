                    ...
                    <!-- hahrian -->
                     <div role="tabpanel" class="tab-pane in active" id="harian">
                        <div class="statistic-chart-1">
                           <center>
                              <h2 class="title-3 m-b-30">Grafik Penjualan Mulia pada Tgl <?= date("d M Y"); ?></h2>
                           </center>
                           ...
                           <div class="statistic-chart-1-note">
                              <center><input class="btn btn-lg btn-default" style="background-color:#393939; color:#cc9933" type="button" value="Export Data" onclick="window.location.href='<?= site_url('Home/exportmuliaharian');?>'" /></center>
                     ...
                     <div role="tabpanel" class="tab-pane" id="mingguan">
                        <div class="statistic-chart-1">
                           <center>
                              <h2 class="title-3 m-b-30">Grafik Penjualan Mulia pada Mingguan</h2>
                           </center>
                           <div class="chart-wrap">
                              <canvas id="myChart2"></canvas>
                              <br>
                              <center><input class="btn btn-lg btn-default" style="background-color:#393939; color:#cc9933" type="button" value="Export Data" onclick="window.location.href='<?= site_url('Home/exportmuliamingguan');?>'" /></center>
                     ...
                     <div role="tabpanel" class="tab-pane " id="bulanan">
                        <div class="statistic-chart-1">
                           <center>
                              <h2 class="title-3 m-b-30">Grafik Penjualan Mulia pada Bulanan</h2>
                           </center>
                           <div class="chart-wrap">
                           ...
                           <br>
                           <div class="statistic-chart-1-note">
                              <center><input class="btn btn-lg btn-default" style="background-color:#393939; color:#cc9933" type="button" value="Export Data" onclick="window.location.href='<?= site_url('Home/exportmuliabulanan');?>'" /></center>
