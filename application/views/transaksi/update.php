         ...
         <div class="card">
            ...
            <div class="card-body card-block">
               ...
               <div class="form-group">
                  ...
                  <input type="number" id="jumlah_keping" name="jumlah_keping" placeholder="Jumlah Keping" class="form-control" value="<?php echo $transaksi[0]->jumlah_keping ?>">
               </div>
               <div class="row form-group">
                  <div class="col-8">
                     <div class="form-group">
                        <label for="city" class=" form-control-label">Jumlah Gram</label>
                        <input type="number" id="jumlah_gram" name="jumlah_gram" placeholder="Jumlah Gram" class="form-control" value="<?php echo $transaksi[0]->jumlah_gram ?>">
                     </div>
                  </div>
               </div>
               <div class="form-group">
