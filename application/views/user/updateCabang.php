                  ...
                  <div class="card" style="color:black">
                     ...
                     <div class="card-body">
                        ...
                        <div class="form-group">
                           ...
                           <input id="cc-pament" name="nama" type="text" class="form-control" aria-required="true" aria-invalid="false" required value="<?php echo $user[0]->nama ?>" disabled>
                        </div>
                        <div class="form-group has-success">
                           ...
                           <input id="cc-name" name="username" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card"
                              autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" required value="<?php echo $user[0]->username ?>" disabled>
