   ...
   <div class="row">
      ...
      <div class="col-xs-12 col-lg-4">
         <div class="card" style="margin-top: 3%">
            <div class="card-header">
                ...
                <strong>Mulia <?php echo $activecabang ?> Tahun <?php echo $tahun ?></strong>
                </font>
            </div>
            <div class="card-body">
      ...
      <div class="col-xs-12 col-lg-8 ">
         <div class="card" style="margin-top: 2%">
            <div class="card-header">
               <?php echo form_open('transaksi/admin'); ?>
               <div class="row">
                  <div class="col-xs-12 col-lg-4">
                    <font color="black">
	                <small>Transaksi</small>
            ...
            <div class="col-lg-12 col-xs-12">
                ...
                <div class="row">
                    <div class="col-lg-5 col-xs-12">
                        ...
                        <small>Daftar Transaksi Mulia Bulan</small>
                                   ...
                                   <div style="padding-top: 1%" class="col-xs-12 col-lg-3 rs-select2--dark rs-select2--dark2">
                                    ...
                                    <div style="padding-top: 1%; display: none;" id="frmtambah" class="col-xs-12 col-lg-9 rs-select2--dark rs-select2--dark2">
                                       <div class="row">
                                          ...
                                          <div class="col-lg-4 col-xs-12">
                                             <button style="float:rifgt;" name="btn" onclick="window.location = '<?= site_url();?>/Home/exportmuliabulanan/'+document.getElementById('pilihbulan').value+'/'+document.getElementById('tahun').value" class="btn btn-sm btn-success">EXPORT</button>  
                                          </div>
                                       </div>       
                                    </div>
                                <!--btn EXPORTend-->
               ...
               <div class="table-responsive table--no-card m-b-30" style="background-color: white"  >
                  <table class="table table-borderless table-striped table-earning" id="example" style="width:100%;padding: 1%">
                     <thead>
                        <tr >
                           <th>No</th>
                           <th>No Kredit</th>
